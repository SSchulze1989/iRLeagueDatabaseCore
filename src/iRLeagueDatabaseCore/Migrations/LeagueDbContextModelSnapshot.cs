...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iRLeagueDatabaseCore.Models.AcceptedReviewVoteEntity", b =>
                {
                    ...
                    b.HasIndex("LeagueId", "TeamAtFaultId");
            ...
            modelBuilder.Entity("iRLeagueDatabaseCore.Models.AddBonusEntity", b =>
                {
                    b.Property<long>("LeagueId")
                        .HasColumnType("bigint");

                    b.Property<long>("AddBonusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("LeagueId", "AddBonusId");

                    b.HasAlternateKey("AddBonusId");
            ...
            modelBuilder.Entity("iRLeagueDatabaseCore.Models.IncidentReviewsInvolvedTeams", b =>
                {
                    ...
                    b.Property<long>("TeamRefId")
                        .HasColumnType("bigint");

                    b.HasKey("ReviewRefId", "LeagueId", "TeamRefId");

                    b.HasIndex("LeagueId", "ReviewRefId");

                    b.HasIndex("LeagueId", "TeamRefId");

                    b.ToTable("IncidentReviewsInvolvedTeams");
                });
            ...
            modelBuilder.Entity("iRLeagueDatabaseCore.Models.LeagueEntity", b =>
                {
                    ...
                    b.Property<bool>("EnableLiveReviews")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<int>("ProtestFormAccess")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("iRLeagueDatabaseCore.Models.AcceptedReviewVoteEntity", b =>
                {
                    ...
                    b.HasOne("iRLeagueDatabaseCore.Models.TeamEntity", "TeamAtFault")
                        .WithMany()
                        .HasForeignKey("LeagueId", "TeamAtFaultId");
            ...
            modelBuilder.Entity("iRLeagueDatabaseCore.Models.IncidentReviewsInvolvedTeams", b =>
                {
                    b.HasOne("iRLeagueDatabaseCore.Models.IncidentReviewEntity", "Review")
                        .WithMany()
                        .HasForeignKey("LeagueId", "ReviewRefId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("iRLeagueDatabaseCore.Models.TeamEntity", "Team")
                        .WithMany()
                        .HasForeignKey("LeagueId", "TeamRefId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
