...
namespace iRLeagueDatabaseCore.Migrations
{
    ...
    [Migration("20221026220147_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iRLeagueDatabaseCore.Models.StandingsScorings", b =>
                {
                    ...
                    b.Property<long>("StandingRefId")
                        .HasColumnType("bigint");

                    b.HasKey("ScoringRefId", "LeagueId", "StandingRefId");

                    b.HasIndex("LeagueId", "ScoringRefId");

                    b.HasIndex("LeagueId", "StandingRefId");

                    b.ToTable("StandingsScorings");
                });
            ...
            modelBuilder.Entity("iRLeagueDatabaseCore.Models.StandingsScorings", b =>
                {
                    b.HasOne("iRLeagueDatabaseCore.Models.ScoringEntity", "ScoringRef")
                        .WithMany()
                        .HasForeignKey("LeagueId", "ScoringRefId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("iRLeagueDatabaseCore.Models.StandingEntity", "StandingRef")
                        .WithMany()
                        .HasForeignKey("LeagueId", "StandingRefId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ScoringRef");

                    b.Navigation("StandingRef");
                });
            ...
            modelBuilder.Entity("iRLeagueDatabaseCore.Models.StatisticSetEntity", b =>
                {
                    ...
                    b.HasOne("iRLeagueDatabaseCore.Models.StandingEntity", "Standing")
                        .WithMany("StatisticSets")
